<template>
    <div class="bg-[#242424] w-full h-[90px] border-t-[1px] border-neutral-700 text-white">
        <div class="flex justify-center px-[25px] items-center w-full h-full gap-[50px] ">
            ...
            <!-- <div class="flex flex-col items-center justify-center gap-5"> -->
                <!-- <div class="flex fill-gray-300 gap-5 justify-center items-center">
                    ...
                    <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 uPxdw"><path d="M13.536 4.5h-1.473a.75.75 0 1 0 0 1.5H16V2.063a.75.75 0 0 0-1.5 0v1.27A8.25 8.25 0 1 0 3.962 15.887a.75.75 0 1 0 .827-1.25A6.75 6.75 0 1 1 13.535 4.5z"></path><path d="M6.303 8.407c.79 0 1.214-.52 1.214-.907h1.5v8h-1.5V9.907H6v-1.5h.303zm4.832-.911h4.05v1.5H12.33l-.245 1.067c.256-.071.525-.11.804-.11 1.621 0 2.954 1.3 2.954 2.924 0 1.624-1.333 2.923-2.954 2.923a2.945 2.945 0 0 1-2.93-2.54l1.487-.197c.092.69.696 1.237 1.443 1.237.813 0 1.454-.647 1.454-1.423s-.64-1.423-1.454-1.423c-.49 0-.92.235-1.183.594l-.01.014-.206.254-1.314-.639.96-4.181z"></path></svg>
                    <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 uPxdw"><path d="M0 4.75A3.75 3.75 0 0 1 3.75 1h8.5A3.75 3.75 0 0 1 16 4.75v5a3.75 3.75 0 0 1-3.75 3.75H9.81l1.018 1.018a.75.75 0 1 1-1.06 1.06L6.939 12.75l2.829-2.828a.75.75 0 1 1 1.06 1.06L9.811 12h2.439a2.25 2.25 0 0 0 2.25-2.25v-5a2.25 2.25 0 0 0-2.25-2.25h-8.5A2.25 2.25 0 0 0 1.5 4.75v5A2.25 2.25 0 0 0 3.75 12H5v1.5H3.75A3.75 3.75 0 0 1 0 9.75v-5z"></path></svg>
                </div>
                <div class="h-[5px] rounded bg-gray-500 cursor-pointer w-[600px]">
                    <div class="h-[5px] bg-gray-100 rounded" style="width: 45%"></div>
                </div> -->
                <!-- <div class="flex">
                    <div data-testid="playback-position" class="text-gray-300 text-[12px]" data-encore-id="type">0:00</div>
                    <div class="h-[1px]" data-testid="playback-progressbar"><label class="hidden-visually"><input disabled="" type="range" min="0" max="0" step="0" aria-valuetext="0:00/0:00" value="0"></label><div class="TywOcKZEqNynWecCiATc" data-testid="progress-bar" style="--progress-bar-transform:0%;"><div class="NoOAOv6U6vtqj_ybS1Cd" data-testid="progress-bar-background"><div class="w699O0LgQRghXyl3bs9u"><div class="epWhU7hHGktzlO_dop6z"></div></div><div class="Vis45PPawTyED7Lt2_LI"></div></div></div></div>
                    <div data-testid="playback-duration" data-test-position="0" class="text-gray-300 text-[12px]" data-encore-id="type">0:00</div>
                </div> -->
            <!-- </div> -->
            <!-- <div class="flex fill-gray-300 gap-3 justify-center items-center">
                ...
                <div class="flex gap-1 justify-center items-center">
                    ...
                    <div class="h-[5px] rounded bg-gray-500 cursor-pointer w-[100px]"><div class="h-[5px] bg-gray-100 rounded" style="width: 45%"></div>
                </div>
                </div>
            </div> -->
        </div>
