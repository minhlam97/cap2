...
function App() {
  // states
  const [audioList, setAudioList] = useState([]); //mảng

  const [apiAudioList, setApiAudioList] = useState([]); //api ban đầu
  const [apiAudioListCopy, setApiAudioListCopy] = useState([]); //api ban đầu->copy
    ...
    <div>
      ...
      <BrowserRouter>
        <div className="d-flex h-90">
          {/* menu */}
          <div className="w-15 text-start pt-5" id="menu">
            {/* logo */}
            <div>
